...
static const std::string filename = "D:/Programacion Paralela/grupal_main2/image02.jpg";
...
void bordes_image() {
    ...
    kernel_bordes(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
...
void bordes_image2() {
    ...
    kernel_bordes2(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
...
int main() {
    ...
    sf::Font font;
    {
        font.loadFromFile("D:/Programacion Paralela/grupal_main2/arial.ttf");
        text.setFont(font);
