...
static const std::string filename = "C:/Programacion Paralela/correccion_cuda/dog.jpg";
...
void min_image() {
    ...
    kernel_min(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
...
void max_image() {
    ...
    kernel_max(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
...
void median_image() {
    ...
    kernel_median(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
